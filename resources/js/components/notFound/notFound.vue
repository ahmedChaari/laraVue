    ...
    <div>
        <div class="container">
            ...
            <div class="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
                ...
                <div class="text-black mt-10 lg:mt-0">
                    ...
                    <router-link :to="{ name:'home.index'}" class="intro-x btn py-3 px-4 text-black border-white dark:border-darkmode-400 dark:text-slate-200 mt-10">
                        Back to Home
                    </router-link>
